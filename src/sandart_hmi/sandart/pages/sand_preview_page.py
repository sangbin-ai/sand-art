...
=========================================================
Sand Art Robot HMI
pages/sand_preview_page.py
Sand Preview Page - Responsive Version
=========================================================
"""
...
class SandPreviewPage(QWidget):
    ...
    def __init__(self):
        ...
        # 창 크기 변경 시 이미지를 다시 그리기 위해 원본 Pixmap 저장
    ...
    def init_ui(self):
        ...
        # ==================================================
        # Left Image : Edge Image
        # ==================================================
        self.left_layout = QVBoxLayout()
        self.left_layout.setSpacing(10)

        self.left_title = QLabel("EDGE IMAGE")
        ...
        self.left_layout.addWidget(self.edge_preview, 1)
        ...
        # ==================================================
        # Right Image : Sand Preview
        # ==================================================
        self.right_layout = QVBoxLayout()
        self.right_layout.setSpacing(10)

        self.right_title = QLabel("SAND PREVIEW")
        ...
        self.right_layout.addWidget(self.preview_image, 1)
        ...
        self.preview_button = QPushButton("Sand Preview")
        ...
        # Sand Preview 버튼은 추후 path 생성 py 연결 예정
    ...
    def set_previous_image(self, pixmap):
        print("SandPage set_previous_image")
        """
        Edge 결과 이미지를 이전 단계 이미지로 표시
        """
    ...
    def set_preview_image(self, pixmap):
        print("SandPage set_preview_image")
        """
        Sand Preview 이미지를 오른쪽 Preview에 표시합니다.
        """
    ...
    def update_preview_image(self):
        """
        현재 QLabel 크기에 맞게 Sand Preview 이미지를 리사이즈합니다.
        """
